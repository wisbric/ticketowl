...
func RunDemo(ctx context.Context, db *pgxpool.Pool, databaseURL, migrationsDir string, logger *slog.Logger) error {
	...
	if err := Run(ctx, db, databaseURL, migrationsDir, logger); err != nil {
